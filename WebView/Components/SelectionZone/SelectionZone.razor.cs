...
public partial class SelectionZone<TItem> : BaseComponent, IAsyncDisposable
{
    private readonly string ScriptPath = $"./_content/{WebViewService.Name}/selectionZone.js";
