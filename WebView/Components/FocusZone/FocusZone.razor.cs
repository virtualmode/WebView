...
namespace WebView
{
    public partial class FocusZone : BaseComponent, IAsyncDisposable
    {
        //[Inject] private IJSRuntime? JSRuntime { get; set; }
        private readonly string ScriptPath = $"./_content/{WebViewService.Name}/focusZone.js";
        private IJSObjectReference? scriptModule;
        //private readonly string BasePath = $"./_content/{WebViewService.Name}/baseComponent.js";
