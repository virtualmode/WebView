...
namespace WebView
{
    public partial class CalloutContent : BaseComponent, IAsyncDisposable
    {
        private readonly string CalloutPath = $"./_content/{WebViewService.Name}/callout.js";
        ...
        [Parameter] public BaseComponent? FabricComponentTarget { get; set; }
