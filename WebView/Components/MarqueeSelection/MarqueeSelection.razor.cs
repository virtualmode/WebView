...
namespace WebView
{
    public partial class MarqueeSelection<TItem> : BaseComponent, IAsyncDisposable
    {
        ...
        private readonly string scriptPath = $"./_content/{WebViewService.Name}/marqueeSelection.js";
